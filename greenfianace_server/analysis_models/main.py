...
from robustness_check import run_robustness_checks, run_core_x_substitution_tests
...
RUN_PREDICTION = True  # 步骤9：【新增】SDM+LSTM空间融合预测模型
...
def main():
    ...
    try:
        ...
        # ---------------------- 步骤5：中介效应分析 ----------------------
        if RUN_MEDIATION:
            print("\n【步骤5/9】中介效应模型（机制分析：Bootstrap检验）")
            mediation_result = run_mediation_analysis(df_final, keep_vars)[0]
